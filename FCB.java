...
//    private String time; // Timestamp, formatted as "15/SEP/23:25PM", limited to 14 characters
    ...
    // Constructor
    public FCB(String name, LocalDateTime time, int numOfBlocks) {
    ...
    public FCB(String name, LocalDateTime time, int numOfBlocks, String dataStartBlock, String indexStartBlock) {
